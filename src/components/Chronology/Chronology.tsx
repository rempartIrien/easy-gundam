					...
					{([year, items]) => (
						<li class="group md:flex md:items-stretch lg:even:flex-row-reverse">
							<Text
								component="div"
								variant="big"
								class="mb-midSectionBottom text-center text-primary-main md:relative md:mb-0 md:mr-chronologyGap md:inline-block md:w-chronologyYearWidth md:max-w-chronologyYearColumnWidth md:border-0 md:border-r-chronologyBorderWidth md:border-solid md:border-primary-main md:pr-chronologyGap md:pt-chronologyBulletPaddingTop md:text-end md:text-primary-text md:after:absolute md:after:right-chronologyBulletRight md:after:top-chronologyBulletTop md:after:inline-block md:after:h-chronologyBulletSize md:after:w-chronologyBulletSize md:after:shrink-0 md:after:translate-y-[-50%] md:after:rounded-full md:after:bg-primary-main md:after:content-[''] lg:max-w-none lg:group-even:ml-chronologyGap lg:group-even:mr-0 lg:group-even:border-l-chronologyBorderWidth lg:group-even:border-r-0 lg:group-even:pl-chronologyGap lg:group-even:pr-0 lg:group-even:text-start lg:group-even:after:left-chronologyBulletRight lg:group-even:after:right-0"
							>
